...
from emilia import arq
from emilia.services.keyboard import Ikb
from emilia.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from emilia.services.tasks import _get_tasks_text, all_tasks, rm_task
from emilia.services.types import InlineQueryResultCachedDocument
from emilia.modules.info import get_chat_info, get_user_info
from emilia.modules.music import download_youtube_audio
from emilia.utils.functions import test_speedtest
from emilia.utils.pastebin import paste
...
**✧ Profiles:** [BOT](t.me/{BOT_USERNAME}) | [Owner 👑](t.me/iAmLiKu1)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
